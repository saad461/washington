...
export default function CookieBanner() {
 ...
 <div className="container-wide py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
 ...
 <p className="label-metadata mt-2">
 ...
 className="px-6 py-3  label-metadata hover:text-white transition-all rounded-xl border border-gray-800 hover:border-gray-700 font-heading"
 >
 Decline
 </button>
 <button
 onClick={handleAccept}
 className="px-6 py-3  bg-indigo-600 text-white label-metadata rounded-xl hover:bg-gray-100 transition-all shadow-sm active:scale-[0.98] font-heading"
 >
 Accept All
 </button>
 </div>
