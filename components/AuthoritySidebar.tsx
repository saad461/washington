...
const AuthoritySidebar: React.FC<AuthoritySidebarProps> = ({ county }) => {
 ...
 <span className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-bold uppercase">Verified Legal Source</span>
 </div>
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1 bg-gray-800 rounded-full text-[10px] uppercase font-bold text-gray-500 tracking-widest font-bold uppercase text-emerald-400 border border-gray-700">
 ...
 <h3 className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-semibold uppercase mb-6 flex items-center gap-2">
 ...
 <h3 className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-semibold uppercase mb-8">Official Authorities</h3>
 ...
 <span className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-bold uppercase group-hover: transition-colors">{link.label}</span>
 </div>
 </a>
 ))}
 </div>
 ...
 <h4 className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-semibold uppercase ">{county.name} Filing Info</h4>
 </div>
 <p className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-bold mb-2">Primary Seat: {county.seat}</p>
 <p className="text-[10px] uppercase font-bold text-gray-500 tracking-widest font-bold leading-relaxed mb-6">{county.courtAddress}</p>
 <div className="flex items-center gap-2 text-[10px] uppercase font-bold text-gray-500 tracking-widest font-bold uppercase ">
