    ...
    <aside className="w-full space-y-12 no-print">
      ...
      <div className="bg-indigo-600 rounded-[3rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-indigo-900/20">
        ...
        <div className="flex items-center gap-3 mb-6 relative z-10">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-100">Verified Legal Source</span>
        </div>
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500 rounded-full text-[9px] font-black uppercase tracking-widest text-emerald-50">
      ...
      <div className="bg-slate-50 rounded-[3.5rem] p-10">
        <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.3em] mb-8 italic">Official Authorities</h3>
          ...
          { label: "WA DSHS Support Center", url: "https://www.dshs.wa.gov/esa/division-child-support", icon: Globe },
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <span className="text-[11px] font-black text-slate-600 uppercase tracking-widest group-hover:text-slate-900 transition-colors">{link.label}</span>
              </div>
            </a>
          ))}
        </div>
      ...
      {county && (
        <div className="p-8 border-2 border-slate-100 rounded-[3rem] border-dashed">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h4 className="text-[11px] font-black text-slate-900 uppercase tracking-[0.2em] underline decoration-indigo-200 underline-offset-4">{county.name} Filing Info</h4>
          </div>
          <p className="text-[10px] font-bold text-slate-500 italic mb-2">Primary Seat: {county.seat}</p>
          <p className="text-[10px] font-medium text-slate-400 leading-relaxed mb-6">{county.courtAddress}</p>
