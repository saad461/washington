...
const MobileStepNav = ({
 ...
 <div
 ref={scrollRef}
 className="flex gap-2 overflow-x-auto px-4 py-3 min-h-[48px] scrollbar-none"
 ...
 : 'bg-white border-gray-200 hover:border-gray-300 hover:'
 }`}
 >
 <span className={`flex items-center justify-center w-4 h-4 rounded-full text-[9px] font-medium ${
...
const InputField = ({
 ...
 {isCurrency && (
 <span className="absolute left-4 top-1/2 -translate-y-1/2 font-medium group-focus-within: transition-colors">
 $
 </span>
 )}
 <input
 ...
 placeholder="0.00"
 className={`w-full h-12 rounded-xl border border-gray-200 bg-white px-4 transition-all focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-600 focus:outline-none font-medium ${isCurrency ? 'pl-8' : ''} ${isPercentage ? 'pr-8' : ''}`}
 />
 {isPercentage && (
 <span className="absolute right-4 top-1/2 -translate-y-1/2 font-medium group-focus-within: transition-colors">
 %
 </span>
 )}
 </div>
...
export default function WorksheetWizard() {
 ...
 <div className="text-center p-12 bg-white rounded-2xl border border-gray-100 shadow-sm max-w-md">
 <Calculator className="w-12 h-12 mx-auto mb-6" />
 <h2 className="font-semibold mb-4">Step Not Found</h2>
 <p className=" font-medium mb-8">The requested worksheet step could not be loaded.</p>
 <button onClick={() => setCurrentStep(0)} className="px-6 py-3 min-h-[48px] bg-indigo-600 text-white font-medium rounded-xl hover:bg-gray-100 transition-colors">
 Back to Start
 </button>
 </div>
 </div>
 ...
 className="space-y-10 md:space-y-12 pb-12 md:pb-24 bg-white p-6 sm:p-6 md:p-12 rounded-xl"
 >
 ...
 id="pdf-edit-btn"
 onClick={resetWizard}
 className="flex items-center gap-2 px-5 py-3 min-h-[48px] bg-white border border-gray-200 font-medium rounded-xl hover:bg-gray-50 transition-all active:scale-[0.98] shadow-sm shrink-0 text-sm"
 >
 ...
 <td className={`px-5 md:px-6 py-3 min-h-[48px] text-sm ${row.bold ? 'font-medium font-heading' : 'font-medium '}`}>
 {row.label}
 </td>
 {row.isReason ? (
 ...
 <>
 <td className={`px-5 md:px-6 py-3 min-h-[48px] text-sm ${row.bold ? 'font-medium ' : 'font-medium '}`}>
 ...
 <button
 id="pdf-download-btn"
 className="w-full sm:w-auto px-8 md:px-6 py-3 min-h-[48px] md:py-5 bg-gray-900 text-white font-medium rounded-xl shadow-sm hover:bg-gray-100 transition-all active:scale-[0.98] flex items-center justify-center gap-3 font-heading"
 ...
 <div className="p-2.5 bg-gray-900 rounded-2xl shadow-sm">
 ...
 className={`w-full group flex items-center gap-4 px-4 py-3  rounded-xl transition-all duration-200 font-medium text-sm ${currentStep === idx
 ? 'bg-gray-50 '
 ...
 <motion.div
 className="mt-8 p-5 md:p-6 bg-gray-900 rounded-2xl relative overflow-hidden shadow-sm"
 layout
 >
 ...
 className={`flex items-center justify-center w-full sm:w-auto px-6 py-3 min-h-[48px] rounded-xl font-medium text-sm transition-all ${currentStep === 0
 ...
 <button
 onClick={nextStep}
 className="flex items-center justify-center w-full sm:w-auto bg-gray-900 text-white px-8 md:px-6 py-3 min-h-[48px] rounded-xl font-medium text-sm hover:bg-gray-100 transition-all active:scale-[0.98] group font-heading"
 >
