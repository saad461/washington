...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-900 section-default mt-auto border-t border-gray-800">
      <div className="container-wide">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 mb-12 md:mb-16">
          {/* Brand Section */}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="label-metadata mb-6 md:mb-8">Calculators</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="label-metadata mb-6 md:mb-8">Resources</h4>
            <ul className="space-y-4 text-sm text-muted">
          ...
          {/* Legal */}
          <div>
            <h4 className="label-metadata mb-6 md:mb-8">Legal</h4>
            <ul className="space-y-4 text-sm text-muted">
        ...
        <div className="pt-8 md:pt-10 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 md:gap-6">
          <div className="text-left">
            <p className="label-metadata mb-3">&copy; 2026 Washington Child Support Schedule Center.</p>
            <p className="max-w-2xl label-metadata text-body leading-relaxed">
          ...
          <div className="flex gap-6 items-center">
            <span className="flex items-center gap-2 label-metadata">
