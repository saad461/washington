...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-gray-400 py-20 mt-auto border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-semibold mb-8 uppercase tracking-[0.2em] text-[10px]">Calculators</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-white font-semibold mb-8 uppercase tracking-[0.2em] text-[10px]">Resources</h4>
            <ul className="space-y-4 text-[13px] font-medium">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-white font-semibold mb-8 uppercase tracking-[0.2em] text-[10px]">Legal</h4>
            <ul className="space-y-4 text-[13px] font-medium">
              ...
              <li className="flex items-center gap-3 hover:text-indigo-400 transition-colors cursor-pointer"><Scale size={14} /><Link href="/terms-of-service">Terms of Service</Link></li>
