...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0F172A] py-10 md:py-16 mt-auto border-t border-gray-800">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-16 mb-10 md:mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-8 text-[#94A3B8]">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] mb-5 md:mb-8">Calculators</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] mb-5 md:mb-8">Resources</h4>
            <ul className="space-y-4 text-sm text-[#94A3B8]">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] mb-5 md:mb-8">Legal</h4>
            <ul className="space-y-4 text-sm text-[#94A3B8]">
        ...
        <div className="pt-8 md:pt-10 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 md:gap-6">
          <div className="text-left">
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] mb-3">&copy; 2026 Washington Child Support Schedule Center.</p>
            <p className="max-w-2xl text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] leading-relaxed">
          ...
          <div className="flex gap-6 items-center">
            <span className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#94A3B8]">
