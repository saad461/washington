  ...
  return (
    <div className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-xl shadow-indigo-900/5">
      <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
        ...
        <button 
          type="submit"
          className="w-full py-5 bg-indigo-600 text-white font-black rounded-2xl shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 transition-all flex items-center justify-center gap-3 active:scale-95"
        >
