...
export default function ContactForm() {
  return (
    <div className="bg-white rounded-2xl p-10 border border-gray-100 shadow-xl shadow-indigo-900/5">
      <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
        <div>
          <label className="block text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Full Name</label>
          <input 
            type="text" 
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Email Address</label>
          <input 
            type="email" 
            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all font-medium"
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Subject</label>
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Message</label>
          <textarea 
            rows={4}
