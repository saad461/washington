...
const LocalInsight: React.FC<LocalInsightProps> = ({ county }) => {
  return (
    <section className="w-full max-w-4xl mx-auto mb-24 px-6 md:px-0">
      <div className="bg-white rounded-[4rem] border-2 border-slate-50 shadow-2xl shadow-indigo-900/5 overflow-hidden transition-all hover:shadow-indigo-900/10">
        <div className="flex flex-col md:flex-row">
          {/* Left Side: Courthouse Identity */}
          <div className="flex-1 p-12 md:p-16 border-b md:border-b-0 md:border-r border-slate-50">
            ...
            <h3 className="text-xl font-black text-slate-800 mb-8 italic tracking-tight">{county.court}</h3>

            <div className="space-y-8">
              <div className="flex items-start gap-5 group">
                <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center flex-shrink-0 transition-colors group-hover:bg-indigo-50">
              ...
              <div className="flex items-start gap-5 group">
                <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center flex-shrink-0 transition-colors group-hover:bg-emerald-50">
          ...
          <div className="flex-1 p-12 md:p-16 bg-slate-50/50 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-8">
              <Info className="w-5 h-5 text-indigo-500" />
              <p className="text-xs font-black text-indigo-900 uppercase tracking-widest">Jurisdictionary Insight</p>
            </div>

            <div className="p-8 bg-white rounded-[3rem] border border-slate-100 shadow-sm mb-10 relative group hover:border-indigo-500 transition-colors">
            ...
            <a 
              ...
              className="inline-flex items-center justify-between p-6 bg-slate-900 rounded-[2rem] text-white font-black text-sm transition-all hover:bg-slate-800 hover:shadow-xl active:scale-95 group"
            >
