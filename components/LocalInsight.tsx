...
const LocalInsight: React.FC<LocalInsightProps> = ({ county }) => {
  return (
    <section className="w-full max-w-4xl mx-auto mb-24 px-6 md:px-0">
      <div className="bg-white rounded-[4rem] border-2 border-gray-50 shadow-2xl shadow-indigo-900/5 overflow-hidden transition-all hover:shadow-indigo-900/10">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-12 md:p-16 border-b md:border-b-0 md:border-r border-gray-50">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500">{county.name} Filing Guide</p>
              </div>
            </div>

            <h3 className="text-xl font-bold text-gray-800 mb-8 tracking-tight">{county.court}</h3>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-5 group">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1">Courthouse Address</p>
              ...
              <div className="flex items-start gap-5 group">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1">Clerk of the Court</p>
          ...
          <div className="flex-1 p-12 md:p-16 bg-gray-50/50 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-8">
              ...
              <p className="text-xs font-bold text-indigo-900 uppercase tracking-widest">Jurisdictionary Insight</p>
            </div>

            <div className="p-8 bg-white rounded-[3rem] border border-gray-100 shadow-sm mb-10 relative group hover:border-indigo-500 transition-colors">
            ...
            <a 
              ...
              className="inline-flex items-center justify-between p-6 bg-gray-900 rounded-[2rem] text-white font-bold text-sm transition-all hover:bg-gray-800 hover:shadow-xl active:scale-95 group"
            >
