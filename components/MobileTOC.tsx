...
export default function MobileTOC({ headings }: MobileTOCProps) {
  ...
  return (
    <details className="lg:hidden mb-8 bg-indigo-50 border border-indigo-100 rounded-2xl overflow-hidden group">
      <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-bold text-sm text-indigo-700 uppercase tracking-[0.2em] select-none list-none">
