...
const AuthorBox = () => {
  return (
    <div className="w-full max-w-4xl mx-auto my-20 pt-16 border-t border-gray-100 no-print font-sans">
      <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-12 shadow-sm relative overflow-hidden group">
        <div className="flex flex-col md:flex-row items-center gap-10 text-center md:text-left relative z-10">
          <div className="relative">
            <div className="w-24 h-24 bg-gray-900 rounded-2xl flex items-center justify-center shadow-md group-hover:rotate-3 transition-transform duration-300">
      ...
      <div className="mt-10 text-center px-12">
        <p className="text-[10px] md:text-xs font-medium text-gray-400 leading-loose">
