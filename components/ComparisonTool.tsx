...
export default function ComparisonTool() {
 ...
 statusColor = ' bg-gray-50 border-gray-100';
 }
 ...
 <div className="bg-white border border-gray-100 shadow-sm rounded-xl p-6 md:p-6 lg:sticky lg:top-32">
 <h2 className="font-semibold mb-8 flex items-center gap-3 font-heading">
 ...
 className="w-full h-14 pl-8 pr-4 rounded-xl border border-gray-200 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-600 outline-none font-medium transition-all text-xl"
 />
 </div>
 </div>
 ...
 <div className={`p-4 rounded-xl border text-center font-medium text-sm tracking-tight ${statusColor}`}>
 {statusText}
 </div>
 </div>
 </div>
 ...
 <div className="bg-white border border-gray-100 rounded-xl p-6 md:p-12 shadow-sm">
 <h3 className="font-semibold mb-8 font-heading">Why did it change?</h3>
 ...
 <div>
 <h4 className="font-semibold mb-2 font-heading">Expanded Economic Tables (Up to $50,000)</h4>
 ...
 <div>
 <h4 className="font-semibold mb-2 font-heading">New 180% Self-Support Reserve (SSR)</h4>
 <p className="text-sm leading-relaxed">
 ...
 <div className="flex gap-5 p-6 bg-indigo-50/50 rounded-xl border border-indigo-50">
 <div className="w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center shrink-0">
 <Info className="w-6 h-6 " />
 </div>
 <div>
 <h4 className="font-semibold mb-2 font-heading">Mandatory Insurance Deductions</h4>
 ...
 <Link href="/worksheet" className="inline-flex items-center justify-center px-6 py-3 min-h-[48px] bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-100 transition-all active:scale-[0.98] w-full font-heading">
