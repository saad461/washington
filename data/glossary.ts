...
export const glossaryTerms: GlossaryTerm[] = [
  {
    ...
    metaTitle: "What is the Self-Support Reserve (SSR) in WA? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is the Self-Support Reserve (SSR) in WA? | WSCSS",
  ...
  },
  {
    ...
    metaTitle: "What is a Child Support Deviation in WA? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is a Child Support Deviation in WA? | WSCSS",
  ...
  },
  {
    ...
    metaTitle: "What is Imputed Income in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is Imputed Income in WA Child Support? | WSCSS",
  ...
  },
  {
    ...
    metaTitle: "What is a Child Support Transfer Payment in WA? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is a Child Support Transfer Payment in WA? | WSCSS",
  ...
  },
  {
    ...
    metaTitle: "What is Combined Net Income in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is Combined Net Income in WA Child Support? | WSCSS",
  ...
  },
  {
    ...
    metaTitle: "What are Extraordinary Expenses in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What are Extraordinary Expenses in WA Child Support? | WSCSS",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is the Basic Child Support Obligation in WA? | Child Support Glossary | WSCSS",
    metaDescription: "The basic child support obligation is the monthly amount from Washington's 2026 economic table based on combined net income and number of children under RCW 26.19.020.",
    h1Title: "What is the Basic Child Support Obligation in Washington State?",
    ogTitle: "What is the Basic Child Support Obligation in WA? | WSCSS",
    ogDescription: "The basic child support obligation is the monthly amount from Washington's 2026 economic table based on combined net income and number of children under RCW 26.19.020.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is the Income Shares Model in WA Child Support? | Child Support Glossary | WSCSS",
    metaDescription: "Washington uses the Income Shares Model where both parents net incomes are combined to determine child support. Each parent pays their proportional share under RCW 26.19.",
    h1Title: "What is the Income Shares Model in Washington Child Support?",
    ogTitle: "What is the Income Shares Model in WA Child Support? | WSCSS",
    ogDescription: "Washington uses the Income Shares Model where both parents net incomes are combined to determine child support. Each parent pays their proportional share under RCW 26.19.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is Proportional Share in WA Child Support? | Child Support Glossary | WSCSS",
    metaDescription: "Proportional share is each parent's percentage of combined net income in Washington child support. It determines each parent's share of the basic obligation and extraordinary expenses under RCW 26.19.080.",
    h1Title: "What is Proportional Share in Washington Child Support?",
    ogTitle: "What is Proportional Share in WA Child Support? | WSCSS",
    ogDescription: "Proportional share is each parent's percentage of combined net income in Washington child support. It determines each parent's share of the basic obligation and extraordinary expenses under RCW 26.19.080.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is Gross Monthly Income in WA Child Support? | Child Support Glossary | WSCSS",
    metaDescription: "Gross monthly income in Washington child support includes all income from any source before deductions. Learn what counts and what is excluded under RCW 26.19.071.",
    h1Title: "What is Gross Monthly Income in Washington Child Support?",
    ogTitle: "What is Gross Monthly Income in WA Child Support? | WSCSS",
    ogDescription: "Gross monthly income in Washington child support includes all income from any source before deductions. Learn what counts and what is excluded under RCW 26.19.071.",
  ...
  },
  {
    ...
    linkLabel: "Read Net Income Guide →",
    relatedLinks: [],
    metaTitle: "What is Net Monthly Income in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is Net Monthly Income in WA Child Support? | WSCSS",
    ogDescription: "Net monthly income in Washington child support is gross income minus mandatory deductions. The 2026 economic table uses net not gross income under RCW 26.19.071.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is the Standard Calculation in WA Child Support? | Child Support Glossary | WSCSS",
    metaDescription: "The standard calculation is the presumptive child support amount in Washington determined by the WSCSS schedule. Courts must use it unless deviation reasons exist under RCW 26.19.035.",
    h1Title: "What is the Standard Calculation in Washington Child Support?",
    ogTitle: "What is the Standard Calculation in WA Child Support? | WSCSS",
    ogDescription: "The standard calculation is the presumptive child support amount in Washington determined by the WSCSS schedule. Courts must use it unless deviation reasons exist under RCW 26.19.035.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is Parenting Time Credit in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is Parenting Time Credit in WA Child Support? | WSCSS",
    ogDescription: "Parenting time credit reduces child support in Washington when the paying parent has significant residential time. Learn how courts calculate this deviation under RCW 26.19.075.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is the Washington Child Support Economic Table 2026? | Child Support Glossary | WSCSS",
    metaDescription: "The 2026 Washington economic table determines the basic child support per child based on combined net income and family size. Learn how to use it under RCW 26.19.020.",
    h1Title: "What is the Washington Child Support Economic Table 2026?",
    ogTitle: "What is the Washington Child Support Economic Table 2026? | WSCSS",
    ogDescription: "The 2026 Washington economic table determines the basic child support per child based on combined net income and family size. Learn how to use it under RCW 26.19.020.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is a Residential Schedule in WA Child Support? | Child Support Glossary | WSCSS",
    metaDescription: "The residential schedule defines when each parent has the child in Washington. It affects child support calculations and parenting time deviations under RCW 26.09.187.",
    h1Title: "What is a Residential Schedule in Washington Child Support?",
    ogTitle: "What is a Residential Schedule in WA Child Support? | WSCSS",
    ogDescription: "The residential schedule defines when each parent has the child in Washington. It affects child support calculations and parenting time deviations under RCW 26.09.187.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What are Healthcare Expenses in WA Child Support? | Child Support Glossary | WSCSS",
    metaDescription: "Healthcare expenses in Washington child support include insurance premiums and uninsured medical costs. They are shared proportionally between parents under RCW 26.19.080.",
    h1Title: "What are Healthcare Expenses in Washington Child Support?",
    ogTitle: "What are Healthcare Expenses in WA Child Support? | WSCSS",
    ogDescription: "Healthcare expenses in Washington child support include insurance premiums and uninsured medical costs. They are shared proportionally between parents under RCW 26.19.080.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What are Daycare Expenses in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What are Daycare Expenses in WA Child Support? | WSCSS",
    ogDescription: "Daycare expenses in Washington child support are work-related childcare costs shared proportionally between parents. Learn how they are calculated under RCW 26.19.080.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is Voluntary Unemployment in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is Voluntary Unemployment in WA Child Support? | WSCSS",
    ogDescription: "Voluntary unemployment in Washington child support triggers income imputation by the court. Learn how courts determine voluntary status under RCW 26.19.071.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is Child Support Modification in WA? | Child Support Glossary | WSCSS",
    metaDescription: "Child support modification in Washington requires a substantial change in circumstances — typically 15% income change. Learn the process under RCW 26.09.170.",
    h1Title: "What is Child Support Modification in Washington State?",
    ogTitle: "What is Child Support Modification in WA? | WSCSS",
    ogDescription: "Child support modification in Washington requires a substantial change in circumstances — typically 15% income change. Learn the process under RCW 26.09.170.",
  ...
  },
  {
    ...
    relatedLinks: [],
    metaTitle: "What is the 45% Income Cap in WA Child Support? | Child Support Glossary | WSCSS",
    ...
    ogTitle: "What is the 45% Income Cap in WA Child Support? | WSCSS",
    ogDescription: "Washington limits child support to 45% of a parent's net income for all children combined. Learn when the cap applies and exceptions under RCW 26.19.065.",
