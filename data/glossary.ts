...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    howItAffects: "Gross income is the starting point for calculating net income. Higher gross income generally means higher net income and a larger proportional share of the basic obligation. Courts verify gross income using tax returns from the past two years and current pay stubs. You can estimate your conversion from gross to net using our <a href='/net-income-calculator' class='text-blue-600 hover:underline'>net income calculator</a>.",
    faqs: [
  ...
  },
  {
    ...
    howItAffects: "Net income is the foundation of the entire calculation. A higher net income means a higher combined income which means a higher table value. It also means a larger income share percentage if your net income is proportionally higher than the other parent's. Use our <a href='/net-income-calculator' class='text-blue-600 hover:underline'>net income calculator</a> to find your accurate net monthly amount.",
    faqs: [
  ...
  },
  {
    ...
    howItAffects: "Healthcare expenses increase total child support beyond the basic transfer payment. The parent who pays insurance directly receives a Line 16a credit. Courts verify insurance premiums — only the portion covering the children is included, not the parent's own coverage. Split your premiums using our <a href='/health-insurance-calculator' class='text-blue-600 hover:underline'>health insurance calculator</a>.",
    faqs: [
