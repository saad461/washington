...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Category</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Details in 2026</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Standard Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000 Combined Monthly Net</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Max Obligation</td><td class='py-3 px-4 text-sm font-medium '>45% of Net Income</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">The Income Shares Model, How Washington Actually Calculates Support</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Item</th><th class='py-3 px-4 text-sm font-medium '>Current Washington Standard</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">First, before you even think about the courthouse: run your estimated support amount through our <a href="/king-county-income-5000-2-children">King County child support calculator</a>. Walking into court with a realistic figure in hand puts you in a genuinely stronger position at every stage of this process.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>King County Court</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Location</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Handles</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Seattle Courthouse</td><td class='py-3 px-4 text-sm font-medium '>516 Third Ave</td><td class='py-3 px-4 text-sm font-medium '>North/Central King County</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Maleng Regional Justice Center</td><td class='py-3 px-4 text-sm font-medium '>401 Fourth Ave N, Kent</td><td class='py-3 px-4 text-sm font-medium '>South King County</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. The Forms You'll Need</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Guideline Factor</th><th class='py-3 px-4 text-sm font-medium '>2026 Amount</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">In simple terms: Washington law says <em>you can't be forced into poverty to pay child support</em>. The SSR is the mechanism that enforces that principle. Set at <strong>approximately $2,394 per month in 2026</strong>, it represents the absolute minimum income the paying parent must be left with after making their monthly payment. If the standard calculation would leave you with less than that, the court <em>must</em> reduce your obligation, often dramatically.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Monthly Net Income</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Support Order Impact</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Below approximately $2,394</td><td class='py-3 px-4 text-sm font-medium '>Reduction applied (often to $50/child)</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>approximately $2,394 - $2,500</td><td class='py-3 px-4 text-sm font-medium '>Standard obligation, unless 45% cap hits</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. Real Math: Three Income Scenarios</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Calculation Metric</th><th class='py-3 px-4 text-sm font-medium '>2026 Value</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">This guide walks through the entire calculation from beginning to end, with a real worked example so you can follow along with your own numbers. By the end, you'll understand exactly where every dollar of a support order comes from, and what you can and can't change about it.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Calculation Phase</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Description</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Combined Net Income</td><td class='py-3 px-4 text-sm font-medium '>Both parents' incomes minus allowed deductions</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Extraordinary Expenses</td><td class='py-3 px-4 text-sm font-medium '>Daycare and health insurance added proportionally</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">Step 1: Determine Each Parent's Gross Monthly Income</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Key Metric</th><th class='py-3 px-4 text-sm font-medium '>2026 Standard</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">The good news: Washington law has built-in protections for genuinely low-income parents. The hard news: the courts take a very dim view of parents who try to game the system by artificially reducing their income. Let's talk through both realities.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Income Level</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Likely Minimum Support</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Under SSR (approximately $2,394)</td><td class='py-3 px-4 text-sm font-medium '>$50 per child minimum</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Zero Income (Voluntary)</td><td class='py-3 px-4 text-sm font-medium '>Imputed income at minimum wage</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. How the SSR Forces a Reduction</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Guideline</th><th class='py-3 px-4 text-sm font-medium '>2026 Rule</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">King County also sees a disproportionate number of high-income cases, tech workers at Amazon, Microsoft, and Boeing, professionals with complex compensation packages, and dual-income households where both parents earn well above the state average. These cases present unique calculation challenges that the standard table handles differently here than anywhere else in Washington.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Compensation Type</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>King County Treatment</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>RSUs (Tech Workers)</td><td class='py-3 px-4 text-sm font-medium '>Counted as gross income upon vesting</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Seattle Daycare</td><td class='py-3 px-4 text-sm font-medium '>Split proportionally (often $2000+/mo)</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. Seattle vs. Kent: Knowing Your Courthouse</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Core Standard</th><th class='py-3 px-4 text-sm font-medium '>2026 Threshold</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">The goal of this guide isn't to scare you, it's to help you understand the full picture so you can make the smartest possible decisions. Sometimes that's fighting the order. Sometimes it's getting back on track. Either way, knowledge is your most valuable tool right now.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Legal Metric</th><th class='py-3 px-4 text-sm font-medium '>2026 Benchmark</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child</td></tr></tbody></table></div><p class="mb-4">Before your hearing, it's worth running your estimated obligation through our <a href="/">calculator</a> and our <a href="/worksheet">Worksheet Wizard</a>. Walking into court knowing your numbers is one of the most practical advantages you can have.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-[var(--color-bg-border)] rounded-xl overflow-hidden'><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Decision Factor</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Court Protocol</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Income Verification</td><td class='py-3 px-4 text-sm font-medium '>Based on W-2, pay stubs, and tax returns</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Deviations</td><td class='py-3 px-4 text-sm font-medium '>Requires specific "good cause" written findings</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. The Mandatory Worksheet Process</h2>
