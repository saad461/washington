...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <p class="mb-4">If you have an older support order and your income has changed by more than 15% under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.09.170' target='_blank' rel='noopener noreferrer'>RCW 26.09.170</a>, or two full years have passed, you can petition for a modification. The process is similar to the original filing but uses the FL 422 family of forms. If your combined income is now around <a href="/king-county-income-7000-2-children">$7,000/month</a>, run a new estimate first so you know whether a modification is worth pursuing.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium '>Item</th><th class='py-3 px-4 text-sm font-medium '>Current Washington Standard</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>$2,394</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>$50 per child per month</td></tr></tbody></table></div><p class="mb-4">First, before you even think about the courthouse: <a href='/worksheet'>complete your child support worksheet online</a> or run your estimated support amount through our <a href="/king-county-income-5000-2-children">King County child support calculator</a>. Walking into court with a realistic figure in hand puts you in a genuinely stronger position at every stage of this process.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <p class="mb-4">If you're appearing without an attorney and the opposing party pushes back on your income claims, be ready to explain how you calculated your net income under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a>, the court responds well to people who've done their homework.</p>
    ...
    faqs: [
      {
        ...
        answer: "Net income, the amount you actually take home after taxes, FICA, mandatory pension contributions, and other legally-allowed deductions under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a>. Gross income before deductions is not the relevant number for SSR calculations."
      },
      {
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <p class="mb-4">Official rules are published by the Washington <a href="https://www.courts.wa.gov/" target='_blank' rel="nofollow">Administrative Office of the Courts</a> and codified in <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a></strong>.</p>
      ...
      <p class="mb-4">From gross income, you subtract only the legally-permitted deductions under <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a></strong>:</p>
       <ul class="list-disc pl-6 space-y-6 mb-8">
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes. Unemployment compensation is defined as gross income under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a>, and DSHS can request an income withholding order directly with the Employment Security Department. Your unemployment benefit can be garnished automatically. The appropriate response if your income has genuinely dropped is to file a modification petition, not to stop paying and wait."
      },
      {
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <p class="mb-4">Washington law, specifically <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.020' target='_blank' rel='noopener noreferrer'>RCW 26.19.020</a></strong>, requires every court to use the standard economic table and complete the official child support worksheets before entering any order. This isn't optional, and courts can't skip it even for "simple" cases.</p>
      ...
      <p class="mb-4">Self-employed income is the most contested category in Washington family court. The court starts with Schedule C or Schedule SE from the federal tax return. Then it decides which business expenses are legitimate deductions under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a> versus personal expenses run through the business. Courts regularly add back expenses like depreciation on personal vehicles, meals, travel, and home office deductions that may be technically valid on taxes but don't reflect actual cash expenditure.</p>
      ...
      <p class="mb-4">A deviation means the court orders a different amount than what the worksheets produce. They're not common, but they happen when there's documented justification. Under <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075</a></strong>, courts can deviate based on:</p>
       <ul class="list-disc pl-6 space-y-6 mb-8">
    ...
    content: `
      ...
      <div class="mt-8 mb-8 p-6 bg-[var(--color-bg-subtle)] rounded-2xl border border-[var(--color-bg-border-soft)]">
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#late-payments" class="text-blue-600 hover:underline">7. What Happens If Payments Are Late?</a></li>
        </ul>
      </div>

      <h2 id="what-is-the-wa-child-support-schedule" class="mt-12 mb-6">What Is the WA Child Support Schedule?</h2>
      <ul class="list-disc pl-6 space-y-2 mb-8">
        <li>Established under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a></li>
...
Transfer payment = Non-residential parent's share</div>
      ...
      <h3 class="mt-8 mb-4">The Imputed Income Trap: What If a Parent Refuses to Work?</h3>
      <p class="mb-4">A common concern is whether a parent can intentionally quit their job or take a lower-paying position to minimize their child support obligation. In Washington, the courts look out for this. If a judge finds that a parent is voluntarily unemployed or underemployed, they will "impute" income to that parent. This means the court assigns a hypothetical income based on the parent's work history, educational background, and local earning potential. If no historical data exists, the court defaults to the state’s minimum wage for a 40-hour work week.</p>
      ...
      <div class="my-8 p-6 bg-blue-50 border border-blue-100 rounded-2xl">
        <p class="font-bold text-blue-900 mb-4">📥 Free Tool: Don't miss a single legal deduction.</p>
        <p class="mb-6 text-blue-800 text-sm">Download our <strong>2026 WA Child Support Document Checklist (PDF)</strong> to ensure you gather every paystub, tax return, and expense receipt required for your Worksheet Wizard.</p>
        <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-[13px] text-blue-800 list-none pl-0 mb-8">
          <li class="flex items-center gap-2">✓ Proof of Income (6 months paystubs)</li>
          <li class="flex items-center gap-2">✓ Tax Records (2 years returns/W-2s)</li>
          <li class="flex items-center gap-2">✓ Self-Employment Records (YTD P&L)</li>
          <li class="flex items-center gap-2">✓ Mandatory Deductions (Union, pension)</li>
          <li class="flex items-center gap-2">✓ Health Insurance (Premium proof)</li>
          <li class="flex items-center gap-2">✓ Special Expenses (Daycare/Medical)</li>
        </ul>
        <div class="flex">
          <a href="#" class="btn btn-primary !py-2 !px-4 !text-xs">Download Checklist (PDF)</a>
        </div>
      </div>
      ...
      <h2 class="mt-12 mb-6">When Can Child Support Be Reviewed or Changed?</h2>
      <p class="mb-6">In Washington, child support orders are not permanent. They can be modified when life circumstances change significantly. Use the table below for a quick glance at the legal requirements for a review.</p>

      <div class="overflow-x-auto mb-12">
        <table class="w-full text-left border-collapse border border-gray-200 rounded-xl overflow-hidden">
          <thead>
            <tr class="bg-gray-50 border-b border-gray-200">
              <th class="py-4 px-4 text-xs font-bold text-gray-900 uppercase tracking-wider">Reason for Modification</th>
              <th class="py-4 px-4 text-xs font-bold text-gray-900 uppercase tracking-wider">Time Frame Allowed</th>
              <th class="py-4 px-4 text-xs font-bold text-gray-900 uppercase tracking-wider">Requirement</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-100">
            <tr>
              <td class="py-4 px-4 text-sm font-bold text-gray-900">Standard Review</td>
              <td class="py-4 px-4 text-sm text-gray-600 font-medium">Every 24 months</td>
              <td class="py-4 px-4 text-sm text-gray-600 leading-relaxed">Requires showing a substantial change in economic circumstances or income.</td>
            </tr>
            <tr class="bg-gray-50/30">
              <td class="py-4 px-4 text-sm font-bold text-gray-900">Child Age Change</td>
              <td class="py-4 px-4 text-sm text-gray-600 font-medium">At any time</td>
              <td class="py-4 px-4 text-sm text-gray-600 leading-relaxed">Automatically triggered when a child turns 12 and moves to the higher-cost bracket.</td>
            </tr>
            <tr>
              <td class="py-4 px-4 text-sm font-bold text-gray-900">Emergency / Severe Change</td>
              <td class="py-4 px-4 text-sm text-gray-600 font-medium">Less than 12 months</td>
              <td class="py-4 px-4 text-sm text-gray-600 leading-relaxed">Requires proving an unprecedented, involuntary hardship (e.g., permanent medical disability).</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    content: `
      <div class="bg-[var(--color-brand-primary-light)] p-4 rounded-xl mb-8">
        ...
        <ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
          ...
          <li>Residential deviations under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075(1)(d)</a> are discretionary</li>
          <li>Even in a true 50/50 split, the higher-earning parent typically still pays</li>
          <li>No fixed percentages exist; the court considers actual expenses of both households</li>
          <li>Use our <a href="/joint-custody-calculator">Joint Custody Calculator</a> to see your 2026 estimated range instantly</li>
        </ul>
      </div>
      ...
      <p class="mb-4">One of the most common misconceptions in Washington family law is that 50/50 custody means zero child support. It doesn't. Washington State allows for a residential deviation under <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075(1)(d)</a></strong> that adjusts the standard support amount based on significant parenting time, but the higher-earning parent almost always still owes something. Here's exactly how it works.</p>

      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Joint Custody Key Figures</caption><thead><tr class='bg-[var(--color-brand-primary-light)] border-y border-[var(--color-brand-primary-mid)]'><th class='py-3 px-4 text-sm font-medium'>Key Figure</th><th class='py-3 px-4 text-sm font-medium'>2026 Standard</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm'>Deviation Threshold</td><td class='py-3 px-4 text-sm font-medium'>Typically 90+ overnights per year</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm'>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium'>$2,394/month</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm'>Minimum Support</td><td class='py-3 px-4 text-sm font-medium'>$50 per child per month</td></tr></tbody></table></div>

      <h2 class="mt-12 mb-6">The Myth of Fixed Percentages</h2>
      <p class="mb-4">Unlike some other states, Washington does <strong>not</strong> have fixed tier percentages or a rigid 'offset method' for joint custody. You may see generic calculators mentioning 6.67%, 16.67%, or 25% reductions — these do not exist in official Washington law. Instead, the court has broad discretion to reduce support if the child spends 'significant time' with the paying parent.</p>

      <p class="mb-4">Under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075(1)(d)</a>, a judge must consider whether the parenting schedule results in increased expenses for the paying parent and decreased expenses for the receiving parent. The court must make written findings of fact to justify any deviation from the standard calculation.</p>

      <h2 class="mt-12 mb-6">How Residential Deviations Are Determined</h2>
      <p class="mb-4">Washington courts generally look at three tiers of parenting time when considering a deviation:</p>
      <ul class="list-disc pl-6 space-y-4 mb-8">
        <li><strong>0 to 90 overnights:</strong> Courts rarely deviate. The standard calculation typically applies in its entirety.</li>
        <li><strong>91 to 182 overnights:</strong> Considered 'significant' parenting time. Courts may reduce the standard amount, often by 10% to 25% depending on the specific costs shared.</li>
        <li><strong>183 or more overnights (50/50):</strong> With equal time, courts often grant more significant reductions, sometimes as high as 50%. However, a deviation can never result in a payment of $0 or near-zero if it leaves the lower-earning household with insufficient funds.</li>
      </ul>

      <p class="mb-4">This level of judicial discretion is why we built the <a href="/joint-custody-calculator">Joint Custody Range Tool</a> — it provides the estimated bands that Washington judges typically use in real-world courtrooms.</p>

      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Custody Days Impact</caption><thead><tr class='bg-[var(--color-warning-bg)] border-y border-[var(--color-warning-border)]'><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Payer Overnights</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Typical Court Action</th><th class='py-3 px-4 text-sm font-medium text-[var(--color-highlight)]'>Estimated Range</th></tr></thead><tbody><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm'>Under 90 days</td><td class='py-3 px-4 text-sm font-medium'>No deviation</td><td class='py-3 px-4 text-sm font-medium'>100% of Standard Amount</td></tr><tr class='border-b border-[var(--color-bg-border-soft)] bg-[var(--color-bg-subtle)]/50'><td class='py-3 px-4 text-sm'>91–182 days</td><td class='py-3 px-4 text-sm font-medium'>Significant time deviation</td><td class='py-3 px-4 text-sm font-medium'>75% – 90% of Standard</td></tr><tr class='border-b border-[var(--color-bg-border-soft)]'><td class='py-3 px-4 text-sm'>183+ days (50/50)</td><td class='py-3 px-4 text-sm font-medium'>Equal time deviation</td><td class='py-3 px-4 text-sm font-medium'>50% – 75% of Standard</td></tr></tbody></table></div>

      <h2 id="example" class="mt-12 mb-6">A Worked Example: 50/50 Custody</h2>
      <p class="mb-4">Parent A earns $6,000/month net. Parent B earns $3,000/month net. Combined income: $9,000. One child. 2026 WSCSS table shows a basic obligation of approximately $950/month. Parent A's proportional share (the standard amount) is $637/month.</p>
      <ul class="list-disc pl-6 space-y-4 mb-8">
        <li><strong>Standard Amount:</strong> $637/month</li>
        <li><strong>Custody:</strong> 183 overnights (50/50)</li>
        <li><strong>Estimated Court Range (50-75%):</strong> $319 — $478 / month</li>
      </ul>
      <p class="mb-4">The judge will decide where in that range (or even outside of it) the final payment lands, based on who pays for clothing, extracurriculars, and other direct expenses.</p>

      <h2 class="mt-12 mb-6">The 50% Floor Rule</h2>
      <p class="mb-4">It is important to note that Washington law almost never allows a deviation to result in zero support unless the parents have identical incomes. Even with perfect 50/50 custody, a deviation rarely goes below 50% of the standard calculation. The law ensures that the child's basic needs are met in both homes and that the transfer payment does not leave one household with a significantly lower standard of living.</p>

      <h2 class="mt-12 mb-6">What About Childcare in Joint Custody Cases?</h2>
      <p class="mb-4">Work-related childcare costs and health insurance premiums are added on top of the base amount and are always split proportionally based on income. These costs are rarely part of a residential deviation. If daycare costs $1,500/month and Parent A has 67% of combined income, Parent A pays $1,005 of that regardless of the overnight schedule.</p>

      <h2 class="mt-12 mb-6">How to Request a Joint Custody Deviation</h2>
      <p class="mb-4">A residential deviation is not applied automatically. You must:</p>
      <ol class="list-decimal pl-6 space-y-4 mb-8">
        <li>Request a deviation under RCW 26.19.075(1)(d) in your petition.</li>
        <li>Document your precise residential schedule in a proposed Parenting Plan.</li>
        <li>Be prepared to show how your household expenses increase during your parenting time.</li>
        <li>The court must then enter written findings of fact justifying the reduction.</li>
      </ol>
      ...
      <div class="my-8 p-6 bg-blue-50 border border-blue-100 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4"><div><p class="font-semibold text-gray-900 text-base mb-1">Calculate Your Joint Custody Range</p><p class="text-sm text-gray-500">Free · 2026 <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a> Guidelines · Discretionary Range Tool</p></div><a href="/joint-custody-calculator" class="btn btn-primary whitespace-nowrap">Estimate Range →</a></div>
    `,
    faqs: [
      {
        question: "Does 50/50 custody eliminate child support in Washington State?",
        answer: "No. Equal parenting time does not automatically waive support. Washington uses court discretion under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075(1)(d)</a>. If one parent earns significantly more, they will likely still owe a transfer payment to ensure the child's needs are met in both households."
      },
      {
        question: "What is the 135 day rule in Washington child support?",
        answer: "There is no '135 day rule' in official Washington statutory law. While some old worksheets or generic calculators used 135 days as a threshold, RCW 26.19.075 allows for deviations starting whenever parenting time becomes 'significant' (typically 90+ overnights). No fixed formula or percentage exists; it is entirely up to court discretion based on actual expenses."
      },
      {
        question: "Which parent pays child support in a joint custody arrangement in Washington?",
        answer: "The parent with the higher income is designated as the payer. Even in equal 50/50 schedules, the higher earner pays a calculated transfer payment to the lower earner to maintain a consistent standard of living for the child in both homes."
      },
      {
        question: "How do I request a residential deviation in Washington?",
        answer: "You must request a deviation under RCW 26.19.075 in your court filings. You need to provide a proposed parenting plan showing significant time and be prepared to show the court that your household expenses increase (and the other parent's decrease) because of the schedule. The court must then enter written findings of fact."
      },
      {
        question: "Is this calculator accurate for 2026 Washington State joint custody cases?",
        answer: "Our calculator uses the 2026 Washington State Child Support Schedule and provides the estimated deviation bands typically used by judges under RCW 26.19.075. It is an estimate; actual court-ordered amounts depend on a judge's written findings of fact regarding the specific expenses of your case."
      }
    ]
  },
  // BLOG 11
    ...
    content: `
      <div class="bg-[var(--color-brand-primary-light)] p-4 rounded-xl mb-8">
        ...
        <ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
          ...
          <li>Governed by <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075</a></strong> — courts require documented good cause</li>
      ...
      <p class="mb-4">If the court grants a deviation, it <strong>must enter written findings</strong> in the order specifically explaining why the standard amount would be unjust and what facts support the deviation. This is a legal requirement under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075</a> — boilerplate language is not sufficient.</p>
      ...
      <ol class="list-decimal pl-6 space-y-4 mb-8">
        ...
        <li>Identify which specific <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075</a> factor applies to your situation</li>
      ...
      <p class="text-sm mt-8 italic">For official state resources and documentation, please visit the <a href="https://www.dshs.wa.gov" rel="nofollow" class="hover:underline">Washington DSHS</a> or the <a href="https://www.courts.wa.gov" rel="nofollow" class="hover:underline">Washington Courts</a> homepage.</p>
      <div class="my-8 p-6 bg-blue-50 border border-blue-100 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4"><div><p class="font-semibold text-gray-900 text-base mb-1">Calculate Your Deviation Adjusted Amount</p><p class="text-sm text-gray-500">Free · 2026 <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a> Guidelines · Upward and Downward Deviations</p></div><a href="/deviation-calculator" class="btn btn-primary whitespace-nowrap">Calculate Now →</a></div>
    `,
    faqs: [
      {
        question: "What is a child support deviation in Washington State?",
        answer: "A child support deviation is a court-approved adjustment that sets support above or below the standard 2026 WSCSS schedule amount. It is governed by <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.075' target='_blank' rel='noopener noreferrer'>RCW 26.19.075</a> and requires the requesting parent to show documented good cause why the standard amount would be unjust. Courts must enter written findings explaining every deviation they grant."
      },
      {
    ...
    content: `
      <div class="bg-[var(--color-brand-primary-light)] p-4 rounded-xl mb-8">
        ...
        <ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
          ...
          <li>Governed by <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.09.170' target='_blank' rel='noopener noreferrer'>RCW 26.09.170</a></strong></li>
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    content: `
      ...
      <p class="mb-4">One of the most contested aspects of any child support case in Washington is what actually counts as income. The definition under <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a></strong> is deliberately broad — the legislature did not want parents to be able to structure their finances to avoid supporting their children. Understanding exactly what is included, what is excluded, and what the court does when it suspects income is being hidden is essential knowledge for any parent going through this process.</p>
      ...
      <p class="mb-4">Washington's definition of gross income for child support purposes is expansive. Under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a>, it includes virtually everything a parent receives:</p>
      <ul class="list-disc pl-6 space-y-4 mb-8">
        ...
        <li><strong>Self-employment income</strong> — gross revenue minus legitimate business expenses under the <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a> standard, not the IRS standard</li>
      ...
      <p class="mb-4">The following are specifically excluded under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a> and do not count toward gross income for child support purposes:</p>
      <ul class="list-disc pl-6 space-y-4 mb-8">
      ...
      <p class="text-sm mt-8 italic">For official state resources and documentation, please visit the <a href="https://www.dshs.wa.gov" rel="nofollow" class="hover:underline">Washington DSHS</a> or the <a href="https://www.courts.wa.gov" rel="nofollow" class="hover:underline">Washington Courts</a> homepage.</p>
      <div class="my-8 p-6 bg-blue-50 border border-blue-100 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4"><div><p class="font-semibold text-gray-900 text-base mb-1">Calculate Your Child Support Using 2026 Income Rules</p><p class="text-sm text-gray-500">Free · <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a> Income Definition · All 39 Washington Counties</p></div><a href="/" class="btn btn-primary whitespace-nowrap">Start Calculation →</a></div>
    `,
    faqs: [
      {
        question: "What income is used to calculate child support in Washington State?",
        answer: "Washington uses gross monthly income as defined under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a>, which includes wages, salary, overtime, bonuses, commissions, self-employment income, rental income, unemployment compensation, disability benefits, Social Security, pension distributions, RSUs, and investment income. The definition is deliberately broad to prevent parents from structuring their finances to reduce apparent income."
      },
      {
      ...
      },
      {
        ...
        answer: "Self-employment income is calculated as gross business revenue minus legitimate business expenses under the <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a> standard, which is stricter than the IRS standard. Courts regularly add back deductions like depreciation, excessive vehicle expenses, and personal costs run through the business that do not represent actual cash outflows reducing the parent's available income."
      },
      {
        question: "What is imputed income in Washington child support cases?",
        answer: "Imputed income is income assigned by the court to a parent who appears to be voluntarily working less than they are capable of. Under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a>(6), if a court finds a parent is voluntarily underemployed, it assigns income at the level the parent could reasonably earn based on their work history, education, and the local job market — at minimum, Washington's current minimum wage for full-time work."
      },
      {
        question: "Is unemployment compensation counted as income for child support in Washington?",
        answer: "Yes. Unemployment compensation is defined as gross income under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a> in Washington State. DSHS can request an income withholding order directly with the Employment Security Department, meaning unemployment benefits can be garnished to pay child support. Receiving unemployment does not pause or reduce your existing child support obligation — you must file a modification petition to change the order amount."
      }
    ]
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    content: `
      ...
      <p class="mb-4">Every child support order in Washington State begins with the same document: the Washington State Child Support Schedule (WSCSS) economic table. It is a published table that shows how much Washington believes it costs to raise children at different combined income levels, and it is legally mandated as the starting point for every calculation under <strong><a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a></strong>. Understanding how to read it, and what it actually tells you, demystifies a large portion of the child support process.</p>
      ...
      <ol class="list-decimal pl-6 space-y-4 mb-8">
        <li><strong>Calculate both parents' monthly net income</strong> after all permitted deductions under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19.071' target='_blank' rel='noopener noreferrer'>RCW 26.19.071</a></li>
    ...
    faqs: [
      {
        ...
        answer: "The Washington State Child Support Schedule (WSCSS) is the legally mandated framework for calculating child support in Washington, established under <a href='https://app.leg.wa.gov/RCW/default.aspx?cite=26.19' target='_blank' rel='noopener noreferrer'>RCW 26.19</a>. Its core component is an economic table that shows the Basic Support Obligation — the estimated total cost of raising children — at different combined parental income levels. Every child support order in Washington must start with this table."
      },
      {
