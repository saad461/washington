...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <p class="mb-4">Want to check your own numbers? Use our <a href="/">Washington child support calculator</a> to run the estimate instantly, or try the new <a href="/joint-custody-calculator">Joint Custody Calculator</a> for 50/50 schedules, or the <a href="/worksheet">Professional Worksheet Wizard</a> for the full 8-part breakdown.</p>
