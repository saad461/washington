...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <p>One of the most important protections in Washington child support law is the Self-Support Reserve, currently set at <strong>approximately $2,394 per month in 2026</strong>. The legislature's reasoning is straightforward: you can't help your children if you've been driven into poverty yourself.</p>

      <p>Here's how it works: before finalizing any support order, the court performs an SSR check. If the calculated support amount would leave the paying parent with less than approximately $2,394 after making the payment, the court <em>must</em> reduce the obligation — often all the way down to the statutory minimum of <strong>$50 per child per month</strong>.</p>
      ...
      <p>Read our full deep-dive on this topic: <a href="/blog/washington-ssr-self-support-reserve-explained">Understanding the approximately $2,394 Self-Support Reserve in 2026</a>.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <table class='w-full text-left border-collapse my-6'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-bold text-amber-900'>Monthly Net Income</th><th class='py-3 px-4 text-sm font-bold text-amber-900'>Support Order Impact</th></tr></thead><tbody><tr class='border-b border-slate-100'><td class='py-3 px-4 text-sm text-slate-700'>Below approximately $2,394</td><td class='py-3 px-4 text-sm font-semibold text-slate-900'>Reduction applied (often to $50/child)</td></tr><tr class='border-b border-slate-100 bg-slate-50/50'><td class='py-3 px-4 text-sm text-slate-700'>approximately $2,394 - $2,500</td><td class='py-3 px-4 text-sm font-semibold text-slate-900'>Standard obligation, unless 45% cap hits</td></tr></tbody></table><h2>2. Real Math: Three Income Scenarios</h2>
      ...
      <p>At $2,200, if the calculated obligation is $400: $2,200 - $400 = $1,800 remaining, which does clear the approximately $2,394 SSR. The standard obligation holds. However, if the income drops — say, to $1,900 — recalculate: $1,900 - $400 = $1,500 (below approximately $2,394). Now the SSR kicks in and the obligation must be reduced.</p>
      ...
      <p>Yes, absolutely. If you were paying based on an older order established before the SSR was raised — or before your income dropped — you may now be entitled to a reduction. If your current income is hovering near the approximately $2,394 threshold, it's worth running a fresh calculation and potentially filing a Petition to Modify Child Support.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <table class='w-full text-left border-collapse my-6'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-bold text-amber-900'>Income Level</th><th class='py-3 px-4 text-sm font-bold text-amber-900'>Likely Minimum Support</th></tr></thead><tbody><tr class='border-b border-slate-100'><td class='py-3 px-4 text-sm text-slate-700'>Under SSR (approximately $2,394)</td><td class='py-3 px-4 text-sm font-semibold text-slate-900'>$50 per child minimum</td></tr><tr class='border-b border-slate-100 bg-slate-50/50'><td class='py-3 px-4 text-sm text-slate-700'>Zero Income (Voluntary)</td><td class='py-3 px-4 text-sm font-semibold text-slate-900'>Imputed income at minimum wage</td></tr></tbody></table><h2>2. How the SSR Forces a Reduction</h2>
      <p>The <strong>Self-Support Reserve of approximately $2,394/month</strong> is what makes the $50 minimum relevant for most low-income cases. Here's the chain of events:</p>
      <ol>
      ...
      <p>At $2,000/month, you have $486 above the SSR ($2,000 - approximately $2,394 = $486). If the standard calculation generates a $600 obligation, the court would reduce it to fit within that $486 ceiling — likely ordering around $200-$250/month after the SSR test. Still substantial for a tight budget, but far less than the standard amount.</p>
