...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Factor</th><th class='py-3 px-4 text-sm font-medium '>Value (2026)</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">This guide walks you through everything that matters: what actually changed in 2026, how the math works, what the courts are required to do, and where you have room to push back. We'll talk about real numbers, real situations, and what to realistically expect when you walk into a King County courtroom or log into Pierce County's e-filing system.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Category</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Details in 2026</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Standard Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000 Combined Monthly Net</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Max Obligation</td><td class='py-3 px-4 text-sm font-medium '>45% of Net Income</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">The Income Shares Model, How Washington Actually Calculates Support</h2>
    ...
    <div class="mt-8 mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-100"><h3 class="font-semibold text-gray-800 mb-4">Calculate Your Obligations</h3><ul class="space-y-2"><li><a href="/worksheet" class=" hover:underline">Calculate your exact support using the Professional Worksheet</a></li><li><a href="/income-5000-2-children" class=" hover:underline">See real example for $5,000 income and 2 children</a></li><li><a href="/king-county-income-6000-1-child" class=" hover:underline">View King County example for $6,000 income</a></li><li><a href="/pierce-county-income-4000-2-children" class=" hover:underline">See Pierce County example at $4,000 income</a></li></ul></div><p class="text-sm  mt-8 italic">For official state resources and documentation, please visit the <a href="https://www.dshs.wa.gov" rel="nofollow" class=" hover:underline">Washington DSHS</a> or the <a href="https://www.courts.wa.gov" rel="nofollow" class=" hover:underline">Washington Courts</a> homepage.</p><div class="mt-6 p-4 bg-indigo-600 text-white rounded-xl text-center"><strong>👉 Calculate Your Exact Child Support</strong><br/>Use our <a href="/worksheet" class="underline">Child Support Calculator</a></div>`,
    faqs: [
      {
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Item</th><th class='py-3 px-4 text-sm font-medium '>Current Washington Standard</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">First, before you even think about the courthouse: run your estimated support amount through our <a href="/king-county-income-5000-2-children">King County child support calculator</a>. Walking into court with a realistic figure in hand puts you in a genuinely stronger position at every stage of this process.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>King County Court</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Location</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Handles</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Seattle Courthouse</td><td class='py-3 px-4 text-sm font-medium '>516 Third Ave</td><td class='py-3 px-4 text-sm font-medium '>North/Central King County</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Maleng Regional Justice Center</td><td class='py-3 px-4 text-sm font-medium '>401 Fourth Ave N, Kent</td><td class='py-3 px-4 text-sm font-medium '>South King County</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. The Forms You'll Need</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
          ...
          <li>When SSR kicks in, the obligation typically drops to a statutory minimum amount</li>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Guideline Factor</th><th class='py-3 px-4 text-sm font-medium '>2026 Amount</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">In simple terms: Washington law says <em>you can't be forced into poverty to pay child support</em>. The SSR is the mechanism that enforces that principle. Set at <strong>approximately $2,394 per month in 2026</strong>, it represents the absolute minimum income the paying parent must be left with after making their monthly payment. If the standard calculation would leave you with less than that, the court <em>must</em> reduce your obligation, often dramatically.</p>
      ...
      <p class="mb-4">Think of it as a test the court runs on every order: <em>"After this parent pays child support, will they have at least approximately $2,394 left to survive on?"</em> If the answer is no, the court cannot approve the standard calculated amount. It has to reduce the payment until the parent retains approximately $2,394, or cap it at a court-ordered statutory minimum.</p>

      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Monthly Net Income</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Support Order Impact</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Below approximately $2,394</td><td class='py-3 px-4 text-sm font-medium '>Reduction applied to statutory minimum</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>approximately $2,394 - $2,500</td><td class='py-3 px-4 text-sm font-medium '>Standard obligation, unless 45% cap hits</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. Real Math: Three Income Scenarios</h2>
      ...
      <p class="mb-4">You can see exactly how these calculations work for your actual income using our <a href="/">Washington child support calculator</a>.</p>
       ...
       <h2 class="mt-12 mb-6">3. The Statutory Minimum, The Absolute Floor Beneath the Floor</h2>
      <p class="mb-4">Even when the SSR calculation brings the obligation down dramatically, Washington maintains a presumptive floor of a <strong>statutory minimum amount</strong>. This means no matter how low your income, you are expected to contribute something toward your children's support. It's rarely waived entirely, though in genuine cases of extreme poverty, courts have discretion.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Calculation Metric</th><th class='py-3 px-4 text-sm font-medium '>2026 Value</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">This guide walks through the entire calculation from beginning to end, with a real worked example so you can follow along with your own numbers. By the end, you'll understand exactly where every dollar of a support order comes from, and what you can and can't change about it.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Calculation Phase</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Description</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Combined Net Income</td><td class='py-3 px-4 text-sm font-medium '>Both parents' incomes minus allowed deductions</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Extraordinary Expenses</td><td class='py-3 px-4 text-sm font-medium '>Daycare and health insurance added proportionally</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">Step 1: Determine Each Parent's Gross Monthly Income</h2>
...
<strong>Key Takeaways (2026)</strong>
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
          <li>The presumptive minimum is <strong>statutory minimum per month</strong></li>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Key Metric</th><th class='py-3 px-4 text-sm font-medium '>2026 Standard</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">The good news: Washington law has built-in protections for genuinely low-income parents. The hard news: the courts take a very dim view of parents who try to game the system by artificially reducing their income. Let's talk through both realities.</p>

       <h2 class="mt-12 mb-6">1. The Absolute Minimum: Statutory Minimum</h2>
      <p class="mb-4">Washington law establishes a <strong>presumptive minimum amount</strong> under RCW 26.19.065. This is the floor beneath which no court-ordered support obligation can go in normal circumstances. It's not optional, and it's extremely rare for a court to waive it entirely.</p>

      <p class="mb-4">This minimum applies when the Self-Support Reserve calculation brings the obligation down dramatically, when a parent's income is so low that the regular formula would leave them destitute. In those cases, the court ordinarily reduces the obligation to the statutory baseline rather than following the standard table amount.</p>

      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Income Level</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Likely Minimum Support</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Under SSR (approximately $2,394)</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Zero Income (Voluntary)</td><td class='py-3 px-4 text-sm font-medium '>Imputed income at minimum wage</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. How the SSR Forces a Reduction</h2>
      <p class="mb-4">The <strong>Self-Support Reserve of approximately $2,394/month</strong> is what makes the $50 minimum relevant for most low-income cases. Here's the chain of events:</p>
       <ol class="list-decimal pl-6 space-y-6 mb-8">
        ...
        <li>The obligation must be reduced to the statutory minimum</li>
      </ol>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Guideline</th><th class='py-3 px-4 text-sm font-medium '>2026 Rule</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">King County also sees a disproportionate number of high-income cases, tech workers at Amazon, Microsoft, and Boeing, professionals with complex compensation packages, and dual-income households where both parents earn well above the state average. These cases present unique calculation challenges that the standard table handles differently here than anywhere else in Washington.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Compensation Type</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>King County Treatment</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>RSUs (Tech Workers)</td><td class='py-3 px-4 text-sm font-medium '>Counted as gross income upon vesting</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Seattle Daycare</td><td class='py-3 px-4 text-sm font-medium '>Split proportionally (often $2000+/mo)</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. Seattle vs. Kent: Knowing Your Courthouse</h2>
      ...
      <p class="mb-4">Full-time infant and toddler daycare in Seattle regularly costs between $2,000 and $2,800 per month per case, among the highest in the country. This is added to the child support worksheet as a work-related childcare expense and split proportionally between both parents.</p>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Core Standard</th><th class='py-3 px-4 text-sm font-medium '>2026 Threshold</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">The goal of this guide isn't to scare you, it's to help you understand the full picture so you can make the smartest possible decisions. Sometimes that's fighting the order. Sometimes it's getting back on track. Either way, knowledge is your most valuable tool right now.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Violation/Arrearage</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Enforcement Action</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Missed payments</td><td class='py-3 px-4 text-sm font-medium '>Income Withholding Order (Wage Garnishment)</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>&gt;$1,000 Arrears</td><td class='py-3 px-4 text-sm font-medium '>Driver's license suspension</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>&gt;$2,500 Arrears</td><td class='py-3 px-4 text-sm font-medium '>Passport denial/revocation</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. The Financial Trap: 12% Annual Interest on Arrears</h2>
...
<ul class="space-y-2 text-indigo-800 list-disc ml-6 mt-2">
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-indigo-50 border-y border-indigo-100'><th class='py-3 px-4 text-sm font-medium '>Legal Metric</th><th class='py-3 px-4 text-sm font-medium '>2026 Benchmark</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Self Support Reserve</td><td class='py-3 px-4 text-sm font-medium '>approximately $2,394</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Economic Table Limit</td><td class='py-3 px-4 text-sm font-medium '>$50,000</td></tr><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Minimum Support</td><td class='py-3 px-4 text-sm font-medium '>statutory minimum</td></tr></tbody></table></div><p class="mb-4">Before your hearing, it's worth running your estimated obligation through our <a href="/">calculator</a> and our <a href="/worksheet">Worksheet Wizard</a>. Walking into court knowing your numbers is one of the most practical advantages you can have.</p>
      ...
      <div class='overflow-x-auto'><table class='w-full'><caption class='sr-only'>Financial Data Table</caption> text-left border-collapse my-6 border border-gray-200 rounded-xl overflow-hidden'><thead><tr class='bg-amber-50 border-y border-amber-100'><th class='py-3 px-4 text-sm font-medium text-amber-900'>Decision Factor</th><th class='py-3 px-4 text-sm font-medium text-amber-900'>Court Protocol</th></tr></thead><tbody><tr class='border-b border-gray-100'><td class='py-3 px-4 text-sm '>Income Verification</td><td class='py-3 px-4 text-sm font-medium '>Based on W-2, pay stubs, and tax returns</td></tr><tr class='border-b border-gray-100 bg-gray-50/50'><td class='py-3 px-4 text-sm '>Deviations</td><td class='py-3 px-4 text-sm font-medium '>Requires specific "good cause" written findings</td></tr></tbody></table></div> <h2 class="mt-12 mb-6">2. The Mandatory Worksheet Process</h2>
      ...
      <p class="mb-4">The base support amount covers ordinary costs: food, routine clothing, and shelter. Everything beyond that is "extraordinary" and goes through a separate calculation. Courts are fairly consistent about what qualifies:</p>
       ...
       <h3 class="mt-8 mb-4">Generally Excluded:</h3>
       <ul class="list-disc pl-6 space-y-6 mb-8">
