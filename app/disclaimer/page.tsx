...
export const metadata: Metadata = {
  ...
  description: "WSCSS legal disclaimer. All calculations generated by our platform are estimates for educational and informational purposes only.",
  alternates: { canonical: 'https://wscss.site/disclaimer' },
  openGraph: {
    title: "Legal Disclaimer | WSCSS Child Support Calculator",
    description: "WSCSS legal disclaimer. All calculations generated by our platform are estimates for educational and informational purposes only.",
