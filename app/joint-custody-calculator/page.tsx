...
export default function JointCustodyCalculator() {
        ...
        <div className="container-wide relative z-10 text-left">
          ...
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
              Joint Custody <span className="text-blue-600">Calculator 2026</span>
            </h1>
            <p className="text-lg text-gray-500 leading-relaxed max-w-2xl">
              Calculate residential schedule adjustments using the official Washington State offset method.
            </p>
          </div>
        </div>
      </section>
