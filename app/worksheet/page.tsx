...
export default function WorksheetPage() {
 ...
 <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 shadow-sm mb-10">
 <p className="mb-3 "><strong>Input:</strong> Combined Monthly Net Income: $5,000 | Children: 2 | County: King County</p>
 <p className="mb-6 "><strong>Output:</strong> Estimated Monthly Basic Support Obligation: $1,155</p>
 <p className=" text-sm ">
