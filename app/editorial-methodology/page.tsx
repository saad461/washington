...
export default function EditorialMethodology() {
 ...
 <div className="prose prose-gray prose-lg max-w-none prose-headings: prose-headings: prose-headings: prose-p: prose-li: prose-strong:">
 <h2 className="text-2xl mb-6">Legal Framework & Data Sources</h2>
 <p>
 ...
 <h2 className="text-2xl mt-16 mb-6">Verification Process</h2>
 <p>
 ...
 <h2 className="text-2xl mt-16 mb-6">Who We Are</h2>
 <p>
 ...
 <h2 className="text-2xl mt-16 mb-6">Our Experience</h2>
 <p>
 ...
 <Link href="/glossary" className=" hover:text-indigo-700 underline decoration-indigo-200 underline-offset-4">Glossary</Link>
 <Link href="/#county-guides" className=" hover:text-indigo-700 underline decoration-indigo-200 underline-offset-4">County Filing Guides</Link>
 </p>

 <div className="mt-16 p-6 bg-gray-50 border border-gray-100 rounded-xl relative overflow-hidden group">
