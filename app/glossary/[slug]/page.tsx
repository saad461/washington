...
export default async function GlossaryTermPage({ params }: Props) {
 ...
 <article className="bg-white border border-gray-100 shadow-sm shadow-indigo-900/5 rounded-xl p-6 md:p-14 mb-12">
 ...
 <h3 className=" mt-12 mb-4">Real-World Example</h3>
 <p className=" bg-emerald-50 text-emerald-900 p-6 rounded-xl">
 {termData.example}
 </p>
 </div>
 ...
 key={idx}
 href={link.href}
 className="flex items-center justify-between p-5 bg-gray-50 hover:bg-indigo-600 hover:text-white rounded-xl transition-colors group flex-1"
 >
