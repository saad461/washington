...
export default function ModificationCalculator() {
  ...
  return (
    <div className="flex-1 w-full bg-white">
        ...
        <div className="container-wide relative z-10 text-left">
          ...
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
              Modification <span className="text-blue-600">Calculator 2026</span>
            </h1>
            <p className="text-lg text-gray-500 leading-relaxed max-w-2xl">
              Determine if your child support order meets the legal thresholds for modification under Washington law.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-default border-t border-gray-100">
        <div className="container-wide">
          <div className="max-w-3xl mx-auto p-8 bg-amber-50 border border-amber-100 rounded-2xl">
