...
export default function AboutPage() {
 ...
 <h2 className="text-xl md: ">Our Mission</h2>
 </div>
 <p className=" md:leading-loose md:pl-9">
 ...
 <h2 className="text-xl md: ">Coverage</h2>
 </div>
 <p className=" md:leading-loose md:pl-9">
 ...
 <h2 className="text-xl md: ">Important Disclaimer</h2>
 </div>
 <p className=" md:leading-loose md:pl-9">
 ...
 <h2 className="text-xl md: ">Contact Us</h2>
 </div>
