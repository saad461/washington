    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 mb-12 md:mb-16">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-indigo-600 mb-1">E-E-A-T Transparency</p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 tracking-tight font-heading">About WCSSC</h1>
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8 text-gray-600">
          <div className="p-6 md:p-10 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:bg-gray-50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              <Scale className="w-5 h-5 text-indigo-500 flex-shrink-0" />
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight font-heading">Our Mission</h2>
            </div>
            <p className="font-medium leading-relaxed md:leading-loose md:pl-9">
          ...
          <div className="p-6 md:p-10 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:bg-gray-50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight font-heading">Data Sources &amp; Methodology</h2>
            </div>
            <div className="font-medium leading-relaxed md:leading-loose md:pl-9 space-y-4">
          ...
          <div className="p-6 md:p-10 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:bg-gray-50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight font-heading">Editorial &amp; Legal Review</h2>
            </div>
            <div className="font-medium leading-relaxed md:leading-loose md:pl-9 space-y-6">
              <p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={s.step} className="p-5 bg-gray-50 rounded-2xl border border-gray-100">
                    ...
                    <p className="text-[10px] font-bold text-gray-900 uppercase tracking-[0.2em] mb-1">{s.label}</p>
          ...
          <div className="p-6 md:p-10 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:bg-gray-50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight font-heading">Coverage</h2>
            </div>
            <p className="font-medium leading-relaxed md:leading-loose md:pl-9">
          ...
          <div className="p-6 md:p-10 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:bg-gray-50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight font-heading">Important Disclaimer</h2>
            </div>
            <p className="font-medium leading-relaxed md:leading-loose md:pl-9">
          ...
          <div className="p-6 md:p-10 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:bg-gray-50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight font-heading">Contact Us</h2>
            </div>
            <div className="font-medium leading-relaxed md:leading-loose md:pl-9">
              ...
              <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 inline-block w-full sm:w-auto">
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-1">General Inquiries &amp; Support</p>
                <a href="mailto:support@wcssc.site" className="text-indigo-600 font-bold underline break-all sm:break-normal">support@wcssc.site</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 p-8 bg-gray-900 rounded-2xl text-center text-gray-400">
          <p className="text-[11px] font-bold uppercase tracking-[0.2em] mb-6">Washington Child Support Schedule Center &copy; 2026</p>
