...
export default function Home() {
 ...
 return (
 <div className="flex-1 flex flex-col items-center px-4 py-10 md:py-16 sm:px-6 lg:px-8 bg-white relative overflow-hidden w-full">
 ...
 <p className="text-base md:text-lg leading-relaxed text-gray-700 max-w-2xl mx-auto px-4">
 ...
 <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 border border-gray-100 rounded-xl p-6 md:p-6 mt-12 w-full shadow-sm">
 {[
 ...
 <div className="text-base md:text-lg leading-relaxed text-gray-700 ">{fig.value}</div>
 </div>
 ))}
 </div>
 ...
 <h2 className=" mb-8 text-center ">Washington Child Support Benchmark Estimates</h2>
 <div className="overflow-x-auto rounded-xl border border-gray-200 shadow-sm bg-white">
 <table className="w-full text-left border-collapse min-w-[500px] border border-gray-100 rounded-xl overflow-hidden">
 <caption className="sr-only">Benchmark Child Support Estimates for Washington State 2026</caption>
 <thead>
 <tr className="bg-gray-50 border-b border-gray-100">
 <th className="px-6 py-3 min-h-[48px] text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase ">Monthly Income</th>
 <th className="px-6 py-3 min-h-[48px] text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase ">1 Child</th>
 <th className="px-6 py-3 min-h-[48px] text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase ">2 Children</th>
 </tr>
 </thead>
 ...
 <td className="px-6 py-3 min-h-[48px] text-sm ">{row.income}</td>
 <td className="px-6 py-3 min-h-[48px] text-sm ">{row.one}</td>
 <td className="px-6 py-3 min-h-[48px] text-sm ">{row.two}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <Link
 href="/worksheet"
 className="group relative inline-flex items-center justify-center px-6 py-3 min-h-[48px] text-lg text-white bg-indigo-600 hover:bg-gray-100 rounded-xl shadow-sm shadow-indigo-100 transition-all hover:-translate-y-1 active:translate-y-0"
 >
 ...
 <section className="mt-28 max-w-3xl w-full mx-auto px-4 relative z-10 font-sans">
 <h2 className=" mb-8 text-center ">Example Calculation</h2>
 <div className="bg-gray-50 border border-gray-100 rounded-xl p-6 md:p-6 shadow-sm">
 <h3 className=" mb-8 text-center">How much is child support for $5,000 income?</h3>
 ...
 <div className="text-[8px] md:text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase md: mb-1 ">{item.label}</div>
 <div className="text-sm md:text-lg ">{item.value}</div>
 </div>
 ))}
 </div>
 </div>

 <div className="bg-indigo-600 rounded-2xl p-6 text-center mb-8 shadow-sm shadow-indigo-100">
 <div className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase text-indigo-200 mb-1">Estimated Basic Support</div>
 <div className="text-3xl text-white ">$1,155<span className="text-sm text-indigo-200 ml-1">/ mo</span></div>
 </div>
 ...
 <section className="mt-20 max-w-3xl w-full mx-auto px-4 pb-24 relative z-10 font-sans">
 ...
 <div className="bg-gray-50 p-6 md:p-6 rounded-xl border border-gray-100">
 <h3 className=" mb-4 ">The 2026 Economic Schedule</h3>
 <p className="mb-4">
 ...
 <div className="space-y-6">
 <h3 >What the Basic Obligation Covers</h3>
 <p>
 ...
 <p className="bg-indigo-50 p-4 rounded-xl text-sm border border-indigo-100 ">
 ...
 <span className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase block mb-2">County Guide</span>
 <span className="text-sm text-gray-800 group-hover:text-indigo-700 transition-colors ">{c.label}</span>
 </Link>
 ))}
 </div>
 ...
 <h3 className=" mb-8 ">Latest Legal Guides</h3>
 ...
 <Link key={p.href} href={p.href} className="block p-6 bg-white border border-gray-100 rounded-xl hover:border-indigo-200 hover:bg-gray-50 transition-all shadow-sm group">
 <span className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase block mb-3">{p.cat}</span>
 <span className="text-sm text-gray-800 group-hover:text-indigo-700 transition-colors leading-snug">{p.label}</span>
 </Link>
 ))}
 </div>
 </div>
