...
export default function Home() {
 ...
 <div className="max-w-3xl w-full mx-auto relative z-10 flex flex-col items-center section-default">
 <div className="text-center mb-16 w-full stack-space">
 <h1 className="text-3xl font-bold text-heading text-center px-2">
 Washington Child Support Calculator
 </h1>
 <p className="text-body text-body leading-relaxed max-w-2xl mx-auto px-4">
 ...
 <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-16 w-full">
 {[
 ...
 <div className="text-body text-body font-semibold">{fig.value}</div>
 </div>
 ))}
 </div>

 {/* ── BENCHMARK DATA TABLE (AI SEO) ── */}
 <div className="section-default w-full" id="benchmark-table">
 <h2 className="text-2xl font-semibold text-heading mb-8 text-center">Washington Child Support Benchmark Estimates</h2>
 ...
 <th className="px-6 py-4 label-metadata">Monthly Income</th>
 <th className="px-6 py-4 label-metadata">1 Child</th>
 <th className="px-6 py-4 label-metadata">2 Children</th>
 </tr>
 </thead>
 ...
 <td className="px-6 py-4 text-base text-body">{row.income}</td>
 <td className="px-6 py-4 text-base text-body">{row.one}</td>
 <td className="px-6 py-4 text-base text-body">{row.two}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <Link
 href="/worksheet"
 className="w-full md:w-auto px-5 py-3 min-h-[48px] rounded-xl border border-gray-300 text-body hover:bg-gray-50 transition flex items-center justify-center gap-2"
 >
 ...
 <section className="section-default max-w-3xl w-full mx-auto px-4 relative z-10 font-sans">
 <h2 className="text-2xl font-semibold text-heading mb-8 text-center">Example Calculation</h2>
 <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm space-y-8">
 <h3 className="text-xl font-semibold text-heading text-center">How much is child support for $5,000 income?</h3>

 <div>
 <div className="label-metadata mb-4 text-center">Scenario</div>
 ...
 <div className="label-metadata mb-1">{item.label}</div>
 <div className="text-body text-heading font-semibold">{item.value}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="label-metadata text-white/80 tracking-widest mb-1">Estimated Basic Support</div>
 ...
 <section className="section-default max-w-3xl w-full mx-auto px-4 pb-24 relative z-10 font-sans">

 <h2 className="text-2xl font-semibold text-heading mb-10 text-center">
 How Washington Child Support Is Calculated
 </h2>

 <div className="space-y-8 text-body text-body leading-relaxed">
 <p>
 ...
 <h3 className="text-xl font-semibold text-heading">The 2026 Economic Schedule</h3>
 <p>
 ...
 <h3 className="text-xl font-semibold text-heading">The Self-Support Reserve (SSR)</h3>
 <p>
 ...
 <div className="space-y-4">
 <h3 className="text-xl font-semibold text-heading">What the Basic Obligation Covers</h3>
 <p>
 ...
 <p className="bg-indigo-50 p-6 rounded-xl text-sm text-body border border-indigo-100">
 ...
 <h2 className="text-2xl font-semibold text-heading mb-10 text-center">Frequently Asked Questions</h2>
 <FAQAccordion items={homeFaqs} />
 </div>

 {/* County quicklinks */}
 <div className="section-default grid grid-cols-2 lg:grid-cols-4 gap-6 w-full">
 {[
 ...
 <span className="text-sm font-semibold text-heading group-hover:text-indigo-700 transition-colors">{c.label}</span>
 </Link>
 ))}
 </div>

 {/* Blog quicklinks */}
 <div className="section-default border-t border-gray-100 w-full">
 <h2 className="text-2xl font-semibold text-heading mb-8">Latest Legal Guides</h2>
 ...
 <span className="label-metadata block mb-3">{p.cat}</span>
 <span className="text-sm font-semibold text-heading group-hover:text-indigo-700 transition-colors leading-snug">{p.label}</span>
 </Link>
 ))}
 </div>
 </div>
