  ...
  return (
    <div className="flex-1 flex flex-col bg-[#F8FAFC] relative overflow-hidden w-full">
      ...
      <section className="section-default w-full relative z-10">
        <div className="max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="text-center mb-16 w-full stack-space">
            <h1 className="text-4xl md:text-5xl font-bold text-heading text-center px-2 leading-tight">
      ...
      {/* ── KEY FIGURES STRIP ── */}
      <section className="section-default w-full bg-[#F1F5F9] relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 w-full">
            {[
              ...
              <div key={i} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm text-center">
                ...
                <div className="text-lg md:text-xl font-semibold text-gray-900">{fig.value}</div>
              </div>
            ))}
          </div>
        </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  <tr key={i} className="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition">
                    <td className="px-6 py-4 text-base font-medium text-gray-800">{row.income}</td>
                    <td className="px-6 py-4 text-base font-medium text-gray-800">{row.one}</td>
                    <td className="px-6 py-4 text-base font-medium text-gray-800">{row.two}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* ── EXAMPLE CALCULATION ── */}
      <section className="section-default w-full bg-[#F1F5F9] relative z-10 font-sans">
        <div className="max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-heading mb-8 text-center">Example Calculation</h2>
          <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm space-y-8 max-w-3xl mx-auto">
      ...
      {/* ── EDUCATIONAL CONTENT ── */}
      <section className="section-default w-full relative z-10 font-sans">
        <div className="max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* ── BLOG QUICKLINKS ── */}
      <section className="section-default border-t border-gray-100 w-full bg-[#F1F5F9] relative z-10">
        <div className="max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Link key={p.href} href={p.href} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-indigo-200 hover:bg-gray-50 hover:-translate-y-1 hover:shadow-md transition-all group">
