...
const Breadcrumbs = ({ title }: { title: string }) => (
 <nav className="flex items-center gap-2 text-[10px] uppercase font-bold text-gray-500 tracking-widest mb-8 flex-wrap">
 <Link href="/" className="hover: transition-colors">Home</Link>
 <span className="mx-3 opacity-30">/</span>
 <Link href="/blog" className="hover: transition-colors">Blog</Link>
 <span className="mx-3 opacity-30">/</span>
...
export default async function BlogPostPage({ params }: Props) {
 ...
 <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 relative z-10">
 ...
 <div className="flex flex-wrap items-center gap-6 py-6 border-y border-gray-100 mb-10">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center border border-gray-100">
 <User size={16} />
 </div>
 <div>
 <p className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase leading-none mb-1">Author</p>
 <p className="text-sm leading-none">{post.author}</p>
 </div>
 </div>
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center border border-gray-100">
 ...
 <div>
 <p className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase leading-none mb-1">Time</p>
 <p className="text-sm leading-none">{post.readTime} Read</p>
 </div>
 </div>
 </div>
 ...
 {/* Featured Image */}
 {post.image?.url && (
 <div className="relative w-full aspect-[16/9] md:aspect-[2/1] rounded-xl overflow-hidden mb-12 shadow-sm border border-gray-100">
 <Image
 src={post.image.url}
 alt={post.image.alt || post.title}
 fill
 ...
 prose-h2:text-2xl md:text-3xl md:prose-h2:text-3xl prose-h2: prose-h2: prose-h2: prose-h2:mt-12 prose-h2:mb-6 prose-h2:-scroll-mt-24 prose-h2:
 prose-h3:text-xl prose-h3: prose-h3: prose-h3:mt-10 prose-h3:mb-4 prose-h3:-scroll-mt-24 prose-h3:
 prose-p: prose-p: prose-p:mb-6
 prose-strong: prose-strong:
 prose-a: prose-a: prose-a:no-underline prose-a:border-b prose-a:border-indigo-100 hover:prose-a:border-indigo-600 transition-colors
 prose-li: prose-li:mb-2
 ...
 <p className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase mb-3 flex items-center gap-2">
 <Scale className="w-4 h-4 " /> E-E-A-T Disclosure
 </p>
 <p className="text-[10px] uppercase font-bold text-gray-500 tracking-widest mb-4">
 All WCSSC insights are reviewed for compliance with RCW 26.19.065 and official AOC guidelines.
 </p>
 <div className="flex flex-wrap gap-4">
 <Link href="/editorial-methodology" className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase hover:text-indigo-800 transition-colors">
 Our methodology &rarr;
 </Link>
 <Link href="/disclaimer" className="text-[10px] uppercase font-bold text-gray-500 tracking-widest uppercase hover:text-indigo-800 transition-colors">
