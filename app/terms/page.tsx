...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Terms of Service | WSCSS — Washington State Child Support Schedule",
    description: "Terms of Service for using the WSCSS child support calculator and educational resources.",
    url: "https://wscss.site/terms",
    siteName: "WSCSS",
    images: [{ url: '/wscss-og.webp', width: 1200, height: 630, alt: 'Terms of Service' }],
    type: "website",
  },
  twitter: {
    card: 'summary_large_image',
    title: "Terms of Service | WSCSS — Washington State Child Support Schedule",
    description: "Terms of Service for using the WSCSS child support calculator.",
