    ...
    <div className="min-h-screen bg-[#FDFDFE] font-sans">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="flex items-center gap-5 mb-16">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-indigo-600 mb-1">Legal Agreement</p>
        ...
        <div className="space-y-8 text-gray-600">
          {[
            ...
            <div key={i} className="p-10 bg-white rounded-[3rem] border border-gray-100 shadow-sm group hover:border-indigo-100 transition-colors">
