...
import {
  Building2, ChevronRight, Phone, MapPin, ExternalLink,
  Lightbulb, Info, CheckCircle2, AlertTriangle,
...
function generateCountyContent(county: WashingtonCounty): {
  ...
  const filingSteps = [
    ...
    { step: `File at ${county.court}`, detail: `Submit your packet to the clerk at ${county.courtAddress}. Pay the filing fee of ${county.filingFee} or request a fee waiver (Form GR 34).` },
    { step: 'Serve the Other Parent', detail: `Have a neutral third party (over 18) serve the filed documents. You cannot serve papers yourself. File the Proof of Service with the clerk.` },
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Courts', item: 'https://wcssc.site/washington-courts' },
          { '@type': 'ListItem', position: 3, name: county!.name, item: `https://wcssc.site/washington-courts/${county!.slug}` }
        ]
      }
    ]
  };
    ...
    <div className="flex-1 bg-[#FDFDFE] w-full font-sans">
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 py-14 md:py-20 text-center">
          {/* Breadcrumb */}
          <nav className="flex items-center justify-center gap-2 mb-8 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight font-heading text-gray-900 mb-6 leading-[1.05] max-w-4xl mx-auto">
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 tracking-tight font-heading">
              Free {county!.name} Child Support Calculator (2026)
            </h2>
            <p className="text-gray-600 text-sm">Enter both parents&apos; monthly net incomes below. Results are based on the official Washington 2026 economic table.</p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
          ...
          <main className="lg:col-span-7 space-y-20">
            ...
            {/* A. INTRODUCTION */}
            <section>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 tracking-tight font-heading leading-tight">
            ...
            {/* B. HOW IT WORKS */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 tracking-tight font-heading">
              ...
              {/* 3. KEY FIGURES */}
              <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-md mt-8">
                <div className="bg-gray-900 text-white px-6 py-4 flex items-center gap-2">
                  <Info className="w-4 h-4 text-indigo-400" />
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em]">2026 Key Figures — Statewide</span>
                </div>
              ...
              <div className="mt-8 space-y-4">
                {content.filingSteps.map((step, i) => (
                  <div key={i} className="flex gap-4 bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1 font-heading">{step.step}</h4>
            ...
            <section>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 mb-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm font-bold uppercase tracking-[0.2em] text-amber-700">Local Expert Tip</span>
                </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
                <div className="bg-gray-900 text-white rounded-2xl p-5 text-center">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-2">Parent A Net</p>
                  <p className="text-2xl font-bold">$5,000</p>
                  <p className="text-xs text-indigo-400 mt-1 font-bold">62.5%</p>
                </div>
                <div className="bg-gray-200 rounded-2xl p-5 text-center">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-2">Parent B Net</p>
                ...
                <div className="bg-indigo-600 text-white rounded-2xl p-5 text-center">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-indigo-200 mb-2">2 Children Total</p>
            ...
            {/* G. FAQs */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-8 tracking-tight font-heading">
            ...
            <section className="bg-indigo-50 border border-indigo-100 rounded-[2rem] p-8">
              ...
              {content.conclusion.map((para, i) => (
                <p key={i} className="text-indigo-800 leading-relaxed mb-4 last:mb-0">
                  {para}
                </p>
              ))}
          ...
          <aside className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="bg-gray-900 text-white rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-5 mb-6">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-1">Physical Address</p>
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-1">Clerk Phone</p>
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-1">Standard Filing Fee</p>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3.5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl transition-colors text-sm"
              >
            ...
            <div className="bg-white border border-gray-200 rounded-[2rem] p-7 shadow-sm">
              ...
              <nav className="flex flex-col space-y-2.5">
                {[
                  { href: '/worksheet', label: 'Official Child Support Worksheet (2026)' },
                  { href: '/extra-expenses', label: 'Proportional Expense Splitter' },
                  { href: '/compare-2024-2026', label: '2024 vs 2026 Guidelines Comparison' },
                  { href: '/glossary/self-support-reserve', label: 'What is the SSR? (Glossary)' },
            ...
            <div className="bg-white border border-gray-200 rounded-[2rem] p-7 shadow-sm">
              ...
              <nav className="flex flex-col space-y-2.5">
                ...
                <Link href="/washington-courts" className="text-xs font-bold text-indigo-600 hover:text-indigo-800 mt-2 block">
